...
final class FullDiskAccessPermissionStore: ObservableObject {
    ...
    func requestAccessPrompt() {
        ...
        alert.informativeText = "Dynamic Island needs Full Disk Access to detect custom Focus indicators. Click Continue to open Full Disk Access settings, then press the + button and select Dynamic Island (we'll reveal it in Finder for you)."
