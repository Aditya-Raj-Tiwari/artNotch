...
struct TimerPreset: Identifiable, Codable, Hashable, Defaults.Serializable {
    ...
    static let defaultPresets: [TimerPreset] = [
        TimerPreset(name: String(localized:"Focus"), duration: 25 * 60, color: Color(white: 0.92)),
        TimerPreset(name: String(localized:"Break"), duration: 5 * 60, color: Color(white: 0.68)),
        TimerPreset(name: String(localized:"Deep Work"), duration: 45 * 60, color: Color(white: 0.48))
    ]
}
